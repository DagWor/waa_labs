...
public class ReactCalculatorPageTest {
    private ReactCalculator reactCalculatorPage;

    @Before
    public void createWebDriver() {
        System.setProperty("webdriver.chrome.driver", "C:\\Users\\Anteneh\\Desktop\\MIU\\WAA\\chromedriver.exe");
        reactCalculatorPage = PageFactory.initElements(new ChromeDriver(), ReactCalculator.class);
        reactCalculatorPage.open("http://localhost:3000/part-4");
    }
